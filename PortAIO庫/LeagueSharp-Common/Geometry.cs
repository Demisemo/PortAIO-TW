namespace LeagueSharp.Common
{
    ...
    public static class Geometry
    {
        ...
        // Token: 0x06000771 RID: 1905 RVA: 0x00020D78 File Offset: 0x0001EF78
        public static float AngleBetween(this Vector3 vector3, Vector3 toVector3)
        {
            ...
            return (float)Math.Cos((double)num3 / num * num2);
        }
        ...
        // Token: 0x0600073B RID: 1851 RVA: 0x0000A8B0 File Offset: 0x00008AB0
        public static float Distance(this Obj_AI_Base target1, GameObject target2, bool squared = false)
        {
            return target1.ServerPosition.To2D().Distance(target2.Position.To2D(), squared);
        }
        ...
        {
            return v.To2D().Distance(other.To2D(), squared);
        }
        ...
        // Token: 0x0600074D RID: 1869 RVA: 0x0000AA32 File Offset: 0x00008C32
        public static float DistanceSquared(this Vector2 pos1, Vector2 pos2)
        {
            return Vector2.DistanceSquared(pos1, pos2);
        }

        // Token: 0x0600074E RID: 1870 RVA: 0x0000AA3B File Offset: 0x00008C3B
        public static float DistanceSquared(this Vector3 pos1, Vector3 pos2)
        {
            return pos1.To2D().DistanceSquared(pos2.To2D());
        }

        // Token: 0x0600074F RID: 1871 RVA: 0x0000AA4E File Offset: 0x00008C4E
        public static float DistanceSquared(this Vector2 pos1, Vector3 pos2)
        {
            return pos1.DistanceSquared(pos2.To2D());
        }

        // Token: 0x06000750 RID: 1872 RVA: 0x0000AA5C File Offset: 0x00008C5C
        public static float DistanceSquared(this Vector3 pos1, Vector2 pos2)
        {
            return pos1.To2D().DistanceSquared(pos2);
        }
        /// <summary>
        ///     Extends the vector.
        /// </summary>
