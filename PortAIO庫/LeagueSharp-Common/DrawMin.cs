...
namespace LeagueSharp.Common
{
    public static class DrawMini
    {
        ...
        public static void DrawCricleMinimap(Vector3 screenPosition, float radius, Color color, float width = 2F, int quality = -1)
        {
            screenPosition = Drawing.WorldToMinimap(screenPosition).To3D();
            radius = radius * MinimapMultiplicator;
