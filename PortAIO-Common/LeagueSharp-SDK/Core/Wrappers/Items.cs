...
namespace LeagueSharp.SDK
{
    ...
    public static class Items
    {
        ...
        {
            return
                GameObjects.Player.InventoryItems.Where(slot => slot.DisplayName == name)
                    .Select(
                        slot =>
        ...
        {
            var wardIds = new[] { 2049, 2045, 2301, 2302, 2303, 3711, 1408, 1409, 1410, 1411, 3932, 3340, 2043, 2055 };
        ...
        {
            return (hero ?? GameObjects.Player).InventoryItems.Any(slot => slot.DisplayName == name);
        }
