...
namespace PortAIO
{
    public static class Init
    {
        ...
        public static void LoadUtility()
        {
            ...
            if (Misc.menu.Item("DeveloperSharp").GetValue<bool>())
            {
                DeveloperSharp.Program.Main();
            }

            if (Misc.menu.Item("Spin2Win").GetValue<bool>())
            {
                Spin2Win.Spin2Win.Main();
            }

            if (Misc.menu.Item("IgniteSharp").GetValue<bool>())
            {
                IgniteSharp.Program.Main();
            }
        }
                ...
                case Champion.Draven:
                    switch (Misc.menu.Item(ObjectManager.Player.Hero.ToString()).GetValue<StringList>().SelectedIndex)
                    {
                        ...
                        case 7: // myWorld AIO
                            ...
                            break;
                        case 8: // Hikicarry ADC
                            HikiCarry.Program.Main();
                            break;
                        case 9: // Flowers' ADC_Series
                            Flowers_ADC_Series.Program.Main();
                            break;
                    }
                    break;
                ...
                case Champion.Ezreal:
                    switch (Misc.menu.Item(ObjectManager.Player.Hero.ToString()).GetValue<StringList>().SelectedIndex)
                    {
                        ...
                        case 19: // IDzEzreal
                            ...
                            break;
                            */
                        case 19: // iEzrealReworked
                            iEzrealReworked.Program.Main();
                            break;
                        case 20: // Perplexed Ezreal
                        ...
                        case 22: // TCSDexAIO
                            Tc_SDKexAIO.PlaySharp.Main();
                            break;
                        case 23: // ProjectGeass
                            _Project_Geass.Program.Main();
                            break;
                        case 24: // Hikicarry ADC
                            HikiCarry.Program.Main();
                            break;
                        case 25: // Flowers' ADC Series
                            Flowers_ADC_Series.Program.Main();
                            break;
                        case 26: // ReformedAIO
                            ReformedAIO.Program.Main();
                            break;
                        case 27: // HandicAPEzreal
                            HandicapEzreal.Program.Main();
                            break;
                        case 28: //yetAnotherEzreal
                    ...
                    case 4: // iLucian
                        ...
                        */
                        ...
                        case 13: // D_Lucian
                            ...
                            break;
                        case 14: // FuckingLucianReborn
                            FuckingLucianReborn.Program.Main();
                            break;
                        case 15: // Slutty Lucian
                ...
                case Champion.Xerath:
                    switch (Misc.menu.Item(ObjectManager.Player.Hero.ToString()).GetValue<StringList>().SelectedIndex)
                    {
                        ...
                        case 3: // ElXerath
                            ...
                            break;
                        case 4: // Xerath - Magnus Ascendant
                            Xerath___The_Magus_Ascendant.Program.Main();
                            break;
                        case 5: // Lord's Xerath
                ...
                case Champion.Yasuo:
                    switch (Misc.menu.Item(ObjectManager.Player.Hero.ToString()).GetValue<StringList>().SelectedIndex)
                    {
                        ...
                        case 9: // ReformedAIO
                            ReformedAIO.Program.Main();
                            break;
                        case 10: // Flowers' Yasuo
                            Flowers_Yasuo.Program.Main();
                            break;
                        case 11: // GosuMechanicsYasuo Rebirth
