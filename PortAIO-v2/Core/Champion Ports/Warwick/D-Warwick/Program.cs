...
namespace D_Warwick
{
    internal class Program
    {
        ...
        public static void Game_OnGameLoad()
        {
            ...
            //Chat.Print("<font color='#881df2'>D-Warwick by Diabaths</font> Loaded.");
        ...
        private static void Smiteontarget(AIHeroClient target)
        {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (_config.Item("CircleLag").GetValue<bool>())
            {
                ...
                {
                    LeagueSharp.Common.Utility.DrawCircle(ObjectManager.Player.Position, _q.Range, System.Drawing.Color.Gray,
                        _config.Item("CircleThickness").GetValue<Slider>().Value,
                        _config.Item("CircleQuality").GetValue<Slider>().Value);
                }
                if (_config.Item("DrawW").GetValue<bool>())
                {
                    LeagueSharp.Common.Utility.DrawCircle(ObjectManager.Player.Position, _w.Range, System.Drawing.Color.Gray,
                        _config.Item("CircleThickness").GetValue<Slider>().Value,
                        _config.Item("CircleQuality").GetValue<Slider>().Value);
                }
                if (_config.Item("DrawE").GetValue<bool>())
                {
                    LeagueSharp.Common.Utility.DrawCircle(ObjectManager.Player.Position, _e.Range, System.Drawing.Color.Gray,
                        _config.Item("CircleThickness").GetValue<Slider>().Value,
                        _config.Item("CircleQuality").GetValue<Slider>().Value);
                }
                if (_config.Item("DrawR").GetValue<bool>())
                {
                    LeagueSharp.Common.Utility.DrawCircle(ObjectManager.Player.Position, _r.Range, System.Drawing.Color.Gray,
                        _config.Item("CircleThickness").GetValue<Slider>().Value,
                        _config.Item("CircleQuality").GetValue<Slider>().Value);
                }
            }
