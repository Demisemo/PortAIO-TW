 ...
 namespace ElUtilitySuite.Trackers
{
    ...
    internal class SpellCountdownTracker : IPlugin
    {
        ...
        public void CreateMenu(Menu rootMenu)
        {
            ...
            menu.AddItem(new MenuItem("XPos", "X 位置").SetValue(new Slider(Drawing.Width - BoxWidth, 0, Drawing.Width)));
            menu.AddItem(new MenuItem("YPos", "Y 位置").SetValue(new Slider(Drawing.Height - BoxHeight * 4, 0, Drawing.Height)));
